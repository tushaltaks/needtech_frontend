                            ...
                            <div className='market_list_itm'>
                                    ...
                                    <div className='market_list_con_in'>
                                        ...
                                        <div className='market_list_info'>
                                            <div className='user_detail'>
                                                <h3 className='heading_type2'><Link to="/">John Smith</Link></h3>
                                                <h4>Electrical Engineer</h4>
                                            </div>                                            
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod  tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim. tempor incididunt ut labore et dolore magna aliqua.</p>
                                ...
                                <div className='market_list_right'>
                                    ...
                                    <div className='service_provider_s'>
                                        <div className='service_provider_logo'><img src={DewberryLogo}/></div>
                                    ...
                                    <div className='market_list_btn'><Link to="/service-provider-detail-login" className='btn btn_primary'>Read More</Link></div>
                                </div>
                            </div>
                            <div className='market_list_itm'>
                                <div className='market_list_img'><div className='market_list_img_in'><img src={ProfilePhoto} /></div></div>
