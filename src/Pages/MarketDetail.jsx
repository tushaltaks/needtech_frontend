            ...
            <div className='inner_head'>
                <Container>
                    <div className='inner_head_in'>
                        <Link to="/marketplace"><img src={BackIc} /> Back to Startups Marketplace</Link>
                    </div>
                </Container>
            </div>
                                ...
                                <Col md={8}>
                                    <div className='market_detail_s_in'>
                                        ...
                                        <div className='market_detail_info'>
                                            ...
                                            <div className='market_list_rate'>
                                                <p>Market Growth:</p>
                                                <h4 className='locked_data'>9.3% <img src={GrowIc} /></h4>
                                            </div>
                                        </div>
                                    </div>
                                </Col>
                            ...
                            <Row>
                                <Col md={8}>
                                    <div className='product_detail_in content_gap'>
                                        ...
                                        <p className='locked_data'>Overall, this innovative Fat Formulation provides a versatile, stable, and customizable platform suitable for a broad range of applications, addressing both functional needs and health considerations.</p>
                                    </div>
                                </Col>
                                <Col md={4}>
