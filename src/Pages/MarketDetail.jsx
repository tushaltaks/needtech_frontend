      ...
      <div className="inner_head">
        <Container>
          <div className="inner_head_in">
            <Link to="/marketplace">
              <img src={BackIc} /> Back to Marketplace
            </Link>
          </div>
        </Container>
      </div>
                  ...
                  <div className="market_detail_s_in">
                    ...
                    <div className="market_detail_info">
                      ...
                      <div className="market_list_rate">
                        ...
                        >
                          {business?.marketGrowth}% <img src={GrowIc} />
                        </h4>
                      </div>
                    </div>
                  </div>
                  ...
                  <Col md={4}>
                    <div className="market_detail_right">
                      ...
                      <div className="acquired_sec">
                        <div className="acquired_sec_img">
                          <img src={Businessic} />
                        </div>
                        <h2 className="acquired_heading">Acquired</h2>
                        <p className="acquired_date">
                          {moment(business?.buisnessPurchasedDate).format(
                            "MMM DD, YYYY"
                          )}
                        </p>
                      </div>
                            ...
                            <div className="bids_meta">
                              <div className="bids_meta_price market_list_rate">
                                ...
                                <h4>
                                  $
                                  {
                                    business?.bidDetailReletedtoBusiness
                                      ?.bidAmount
                                  }
                                </h4>
                              </div>
                              ...
                              >
                                {FirstLettCapital(
                                  business?.bidDetailReletedtoBusiness?.status
                                )}
                              </div>
                            </div>
                          </>
                        ...
                        {showPopup && (
                          <div className="tooltip-box">
                            <p className="tooltip-title">
                              Unlocking this listing will grant you full access
                              to:
                            </p>
                            <ul className="tooltip-list">
                              <li>
                                <CheckCircle color="green" className="icon" />{" "}
                                The abstract of the provisional patent
                              </li>
                              <li>
                                <CheckCircle color="green" className="icon" /> A
                                business overview to grasp the central concept
                              </li>
                              <li>
                                <CheckCircle color="green" className="icon" />{" "}
                                The assets list included with this startup
                              </li>
                              <li>
                                <CheckCircle color="green" className="icon" />{" "}
                                The ability to make a purchase or place a bid
                              </li>
                              <li>
                                <CheckCircle color="green" className="icon" />{" "}
                                Access to a wide range of innovative startups
                              </li>
                            </ul>
                          </div>
                        )}
